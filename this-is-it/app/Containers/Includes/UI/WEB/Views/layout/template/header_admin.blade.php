        ...
        <div class="topbar">
                        ...
                        <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 432px; overflow: hidden;">
                            ...
                            <div class="d-flex align-items-center mt-5">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="text-muted mt-1">{{--\Auth::user()->phone--}}{{'Mai phôn'}}</div>
                                    <div class="navi mt-2">
                            ...
                            <div class="navi navi-spacer-x-0 p-0">
                                ...
                                <a href="{{URL::route('logout')}}" class="navi-item">
                                    <div class="navi-link">
                                        <div class="symbol symbol-40 bg-light mr-3">
                                            <div class="symbol-label">
            ...
            @else
                <div class="topbar-item topbar-item--user">
                    <a href="{{URL::route('login')}}" class="btn btn-danger mr-5">
                        <i class="fa fa-sign-in-alt"></i> Đăng nhập
                    </a>
                </div>
                <!-- <div class="topbar-item topbar-item--user">
                    <a href="{{URL::route('register')}}" class="btn btn-danger">
