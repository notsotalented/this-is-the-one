                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                                                        ...
                                                        <div class="timeline-items">
                                                            <div class="timeline-item timeline-item-left">
                                                                ...
                                                                <div class="timeline-label">
                                                                    <span
                                                                        class="text-dark-50 font-weight-bold">12/7/2023</span>
                                                                </div>
                                                            ...
                                                            <div class="timeline-item timeline-item-right">
                                                                ...
                                                                <div class="timeline-label text-primary">
                                                                    <span
                                                                        class="text-primary font-weight-bold">15/8/2023</span>
                                                                </div>
                                                                <div class="timeline-content max-h-150px overflow-auto">
                                                                    <span class="text-dark-75">
                                                            ...
                                                            <div class="timeline-item timeline-item-left">
                                                                ...
                                                                <div class="timeline-label text-primary">
                                                                    <span
                                                                        class="text-primary font-weight-bold">29/9/2023</span>
                                                                </div>
                                    ...
                                    <div class="navi mt-2">
                                        <a href="#" class="navi-item">
                                            <span class="navi-link p-0 pb-2">
                                                ...
                                                <span
                                                    class="navi-text text-muted text-hover-primary">jm@softplus.com</span>
                                            </span>
                                        </a>
                                        <a href="#"
                    ...
                    <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
                        ...
                        <div class="offcanvas-content px-10">
                            <div class="tab-content">
                                <!--begin::Tabpane-->
                                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs"
                                    role="tabpanel">
                                    <!--begin::Section-->
                                    <div class="mb-15">
                                ...
                                <!--end::Tabpane-->
                                <!--begin::Tabpane-->
                                <div class="tab-pane fade pt-2 pr-5 mr-n5" id="kt_quick_panel_notifications"
                                    role="tabpanel">
                                    <!--begin::Nav-->
                                    <div class="navi navi-icon-circle navi-spacer-x-0">
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">5 new user generated
                                                        report</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">2 new items submited
                                                    </div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">79 PSD files generated
                                                    </div>
                                                    <div class="text-muted">Reports based on sales</div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">$2900 worth producucts
                                                        sold</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">4.5h-aletage response
                                                        time</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                <div class="symbol symbol-50 mr-3">
                                                    <div class="symbol-label">
                                                        <i
                                                            class="flaticon-safe-shield-protection text-danger icon-lg"></i>
                                                    </div>
                                                </div>
                                                <div class="navi-text">
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">Aletage 4 blog posts per
                                                        author</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">16 authors joined last
                                                        week</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">2 new items have been
                                                        submited</div>
                                                    <div class="text-muted">by Grog John</div>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">2.8 GB-total downloads
                                                        size</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link rounded">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold font-size-lg">7 new user generated
                                                        report</div>
                                                    <div class="text-muted">Reports based on sales</div>
                                                </div>
                                            </div>
                    ...
                    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
                        <!--begin::Item-->
                        <li class="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip"
                        ...
                        <li class="nav-item" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip"
                            ...
                            <a class="btn btn-sm btn-icon btn-bg-light btn-text-danger btn-hover-danger" href="#"
                    ...
                    <!--end::Sticky Toolbar-->
                    <script>let HOST_URL = "https://keenthemes.com/metronic/tools/preview";</script>
                    <!--begin::Global Config(global config for global JS scripts)-->
                    <script>let KTAppSettings = { "breakpoints": { "sm": 576, "md": 768, "lg": 992, "xl": 1200, "xxl": 1200 }, "colors": { "theme": { "base": { "white": "#ffffff", "primary": "#3699FF", "secondary": "#E5EAEE", "success": "#1BC5BD", "info": "#8950FC", "warning": "#FFA800", "danger": "#F64E60", "light": "#F3F6F9", "dark": "#212121" }, "light": { "white": "#ffffff", "primary": "#E1F0FF", "secondary": "#ECF0F3", "success": "#C9F7F5", "info": "#EEE5FF", "warning": "#FFF4DE", "danger": "#FFE2E5", "light": "#F3F6F9", "dark": "#D6D6E0" }, "inverse": { "white": "#ffffff", "primary": "#ffffff", "secondary": "#212121", "success": "#ffffff", "info": "#ffffff", "warning": "#ffffff", "danger": "#ffffff", "light": "#464E5F", "dark": "#ffffff" } }, "gray": { "gray-100": "#F3F6F9", "gray-200": "#ECF0F3", "gray-300": "#E5EAEE", "gray-400": "#D6D6E0", "gray-500": "#B5B5C3", "gray-600": "#80808F", "gray-700": "#464E5F", "gray-800": "#1B283F", "gray-900": "#212121" } }, "font-family": "Poppins" };</script>
                    <!--end::Global Config-->
