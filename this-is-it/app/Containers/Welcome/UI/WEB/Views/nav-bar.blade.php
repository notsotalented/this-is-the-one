    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="dropdown-menu">
                        <div class="container-fluid">
                            ...
                            <li><a id="go-to-products" class="dropdown-item"
                                    href="{{ route('web_product_get_all_products') }}">Products</a></li>
                        ...
                        <ul class="dropdown-menu">
                            <div class="container-fluid">
                                ...
                                @can('manage-roles')
                                    ...
                                    <li><a id="go-to-permission" class="dropdown-item"
                                            href="{{ route('role-page-action', ['action' => 'attach']) }}">Manage
                                            Permissions</a></li>
                                    <li><a id="go-to-role" class="dropdown-item" href="{{ route('create-role') }}">Manage
                                            Roles</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
            ...
            @can('search-users')
                ...
                <button type="button" class="btn btn-outline-info mb-2 mb-lg-0 ml-1" data-bs-toggle="modal"
                    data-bs-target="#exampleModal" style="margin-left: 1%">
            ...
            @if (auth()->check())
                <div class="btn-group mb-2 mb-lg-0 ml-1" style="margin-left: 1%">
                    <button type="button" class="btn btn-outline-success dropdown-toggle" data-bs-toggle="dropdown"
                        aria-expanded="false" style="width: 25vh; overflow: hidden">
                        <span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg-end">
                        <li><a class="dropdown-item" href="{{ route('user-profile', ['id' => auth()->id()]) }}">My
            ...
            @else
                <a class="btn btn-success" aria-current="page" href="{{ route('login') }}"
                    style="margin-left: 1%"><b>Login</b></a>
                <a class="btn btn-warning" aria-current="page" href="{{ route('register') }}"
                    style="margin-left: 1%"><b>Register</b></a>
            @endif
        </div>
    </div>
</nav>
    ...
    @if ($errors->any())
        <div id="error_display" class="alert alert-danger alert-dismissible fade show" role="alert">
            @foreach ($errors->all() as $error)
                <li class="list-group-item"><i class="fa-solid fa-triangle-exclamation fa"></i>
                    {{ $error }} </li>
            @endforeach
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="search_id" type="text" class="form-control" placeholder="Exact search"
                            aria-label="search_id" aria-describedby="search_id">
                    </div>
                    <div class="input-group mb-3">
                ...
                <div class="modal-footer">
                    <a id="search_btn" href="#" class="btn btn-info" type="button"
                        style="white-space: nowrap" onclick="finalize_search()"><b>Search <i
                                class="fa-solid fa-magnifying-glass fa-2xs"></i></b></a>
